...
# ============================================================
# SIGMOID BASELINE APPROXIMATION - ALL FORMATS
# ============================================================
# Baseline approach: fixed-width equal segmentation
...
# ============================================================
# EQUAL-WIDTH SEGMENTATION (Baseline)
# ============================================================
boundaries = np.linspace(0, X_MAX, NUM_SEG + 1)
...
# UINT8 (input [-8,8]→[0,255], output [0,1]→[0,255])
...
def quantize_uint8_output(val):
    ...
    return np.round(val_clipped * 255.0) / 255.0
...
# ============================================================
# BUILD BASELINE SEGMENT TABLES
# ============================================================
print("\n" + "="*70)
print("SIGMOID BASELINE APPROXIMATION - ALL FORMATS")
print("="*70)
print(f"Segments: {NUM_SEG}")
print("Segmentation: Equal-width (fixed boundaries)")
print("="*70)
...
# ============================================================
print("\n\n" + "="*70)
print("GLOBAL ERROR SUMMARY - SIGMOID BASELINE")
print("="*70)
...
def approx_uint8(x):
    ...
    return (1.0 - y_q) if sign else y_q
...
print("\n" + "="*70)
print("SIGMOID BASELINE - COMPLETE")
print("="*70)

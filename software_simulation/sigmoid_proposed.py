...
# ============================================================
# SIGMOID PROPOSED APPROXIMATION - ALL FORMATS
# ============================================================
...
# ============================================================
print("\n" + "="*70)
print("SIGMOID PROPOSED APPROXIMATION - ALL FORMATS")
print("="*70)
...
# ============================================================
print("\n\n" + "="*70)
print("GLOBAL ERROR SUMMARY - SIGMOID PROPOSED")
print("="*70)
...
print("\n" + "="*70)
print("SIGMOID PROPOSED - COMPLETE")
print("="*70)

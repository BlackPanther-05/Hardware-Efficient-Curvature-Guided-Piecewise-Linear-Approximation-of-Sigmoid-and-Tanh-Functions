...
# ============================================================
# TANH BASELINE APPROXIMATION - ALL FORMATS
# ============================================================
...
# UINT8 (input [-8,8]→[0,255], output [-1,1]→[0,255])
...
# ============================================================
print("\n" + "="*70)
print("TANH BASELINE APPROXIMATION - ALL FORMATS")
print("="*70)
...
# ============================================================
print("\n\n" + "="*70)
print("GLOBAL ERROR SUMMARY - TANH BASELINE")
print("="*70)

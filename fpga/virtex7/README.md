# Virtex-7 Vivado Implementation Flow

This folder benchmarks the existing sigmoid and tanh RTL on the Virtex-7 device:

- Activations: `sigmoid`, `tanh`
- Methods: `baseline`, `proposed`
- Formats: `int8`, `uint8`, `fp8`, `fp32`
- Device: `xc7v585tffg1157-3`
- Default timing target: 1.667 ns (600 MHz)

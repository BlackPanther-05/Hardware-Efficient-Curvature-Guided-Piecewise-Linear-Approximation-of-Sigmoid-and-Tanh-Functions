// ============================================================
// FP32 TANH TOP MODULE (PROPOSED LUT — EXTERNAL)
// ============================================================
...
// The LUT is a separate module (lut_tanh_fp32) instantiated below.
...
always @(*) begin
        ...
        if (y_positive > 1048576) y_positive = 1048576;
            ...
            q_out = ((y_signed * 2147483647) + (sign_bit ? -524288 : 524288)) / 1048576;
            z = q_out[31:0];

`timescale 1ns/1ps
// ============================================================
// FP8 SIGMOID ERROR TESTBENCH
// ============================================================
// Tests FP8-style fixed-point sigmoid over 256 points
// ============================================================

module tb_sigmoid_fp8_error;

    reg  [7:0] b;
    wire [7:0] z;
    cordic_p1_sigmoid_top_fp8 dut (.clk(clk), .b(b), .z(z));
    ...
    initial begin
        ...
        $display("=====================================================");
        $display(" FP8 Sigmoid RTL Error Test");

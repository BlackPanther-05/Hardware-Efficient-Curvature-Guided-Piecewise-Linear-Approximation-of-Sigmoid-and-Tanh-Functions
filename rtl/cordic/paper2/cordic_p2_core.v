module cordic_p2_core (
    ...
    wire signed [31:0] exp_res = rhc_x[17] + rhc_y[17];
    reg signed [31:0] vlc_x [0:17];
    reg signed [31:0] vlc_y [0:17];
    reg signed [31:0] vlc_z [0:17];
    always @(*) begin
        vlc_x[0] = 1048576 + exp_res;
        vlc_y[0] = 1048576;
        vlc_z[0] = 0;
        if (vlc_y[0] < 0) begin
            vlc_x[1] = vlc_x[0];
        ...
        if (vlc_y[15] < 0) begin
            vlc_x[16] = vlc_x[15];
            vlc_y[16] = vlc_y[15] + (vlc_x[15] >>> 16);
            vlc_z[16] = vlc_z[15] - (1048576 >>> 16);
        end else begin
            vlc_x[16] = vlc_x[15];
            vlc_y[16] = vlc_y[15] - (vlc_x[15] >>> 16);
            vlc_z[16] = vlc_z[15] + (1048576 >>> 16);
        ...
        if (vlc_y[16] < 0) begin
            vlc_x[17] = vlc_x[16];
            vlc_y[17] = vlc_y[16] + (vlc_x[16] >>> 17);
            vlc_z[17] = vlc_z[16] - (1048576 >>> 17);
        end else begin
            vlc_x[17] = vlc_x[16];
            vlc_y[17] = vlc_y[16] - (vlc_x[16] >>> 17);
            vlc_z[17] = vlc_z[16] + (1048576 >>> 17);
    ...
    wire signed [31:0] sigmoid_out = vlc_z[17];

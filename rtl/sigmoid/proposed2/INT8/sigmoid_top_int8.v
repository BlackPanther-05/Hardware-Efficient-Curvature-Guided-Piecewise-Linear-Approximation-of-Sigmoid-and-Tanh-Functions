// ============================================================
// INT8 SIGMOID TOP MODULE (PROPOSED 2 LUT — EXTERNAL)
// ============================================================
...
module sigmoid_top_int8 (
    ...
    always @(*) begin
            case (seg)
                ...
                4'd4: begin m_lut = 32'd131072; c_lut = 32'd589824; end
                4'd5: begin m_lut = 32'd131072; c_lut = 32'd655360; end
                4'd6: begin m_lut = 32'd131072; c_lut = 32'd720896; end
                4'd7: begin m_lut = 32'd65536; c_lut = 32'd786432; end
                4'd8: begin m_lut = 32'd65536; c_lut = 32'd786432; end
                4'd9: begin m_lut = 32'd65536; c_lut = 32'd851968; end
                4'd10: begin m_lut = 32'd0; c_lut = 32'd917504; end
                4'd11: begin m_lut = 32'd0; c_lut = 32'd983040; end
                4'd12: begin m_lut = 32'd0; c_lut = 32'd983040; end
